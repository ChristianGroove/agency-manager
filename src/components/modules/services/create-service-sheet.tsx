...
export function CreateServiceSheet({ clientId, clientName, onSuccess, trigger, open: controlledOpen, onOpenChange: setControlledOpen, serviceToEdit }: CreateServiceSheetProps) {
    ...
    const loadEmitters = async () => {
        const mod = await import("@/lib/actions/emitters")
    ...
    const handleSave = async () => {
        ...
        try {
            ...
            const servicePayload = {
                ...
                // billing_cycle_start_date: billingStart.toISOString(), // Only for new?
                // next_billing_date: cycleEnd.toISOString(), // Only for new?
                ...
                <div className="flex flex-col h-full bg-white/95 backdrop-blur-xl">
                    ...
                    <div className="flex-1 overflow-hidden">
                        <div className="h-full grid grid-cols-1 lg:grid-cols-12 divide-x divide-gray-100/50">
                            ...
                            {/* LEFT: FORM */}
                            <div className="lg:col-span-8 overflow-y-auto p-8 h-full relative scrollbar-thin">
                                {step === 'catalog' ? (
