...
import { FormSubmission } from "@/modules/features/forms/actions"
import {
    Table,
    TableBody,
    TableCell,
...
import { deleteFormSubmission } from "@/modules/features/forms/actions"
...
export function FormList({ submissions }: FormListProps) {
    ...
    const getStatusBadge = (status: string) => {
        switch (status) {
            ...
            default:
                return <Badge variant="outline" className="dark:text-zinc-300 dark:border-white/20">{status}</Badge>
        }
    }
                                ...
                                <button
                                    ...
                                    className={cn(
                                        ...
                                        statusFilter === filter.id
                                            ? filter.id === 'draft' ? "bg-zinc-100 text-zinc-700 ring-1 ring-inset ring-zinc-600/20 shadow-sm"
                    ...
                    <TableBody>
                        {filteredSubmissions.length === 0 ? (
                            ...
                            filteredSubmissions.map((sub) => (
                                <TableRow key={sub.id} className="hover:bg-zinc-50/50 dark:hover:bg-white/5 border-zinc-100 dark:border-white/10">
                                    <TableCell>
                                        <Checkbox
                                    ...
                                    <TableCell className="text-zinc-700 dark:text-zinc-300">{sub.template?.name}</TableCell>
