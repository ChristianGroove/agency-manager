...
import { getContractGeneratorData } from "@/modules/core/tools/contract-generator/contract-actions"
...
export function ContractProvider({ children }: { children: React.ReactNode }) {
    ...
    const generateWithAi = async (customPrompt?: string) => {
        ...
        try {
            ...
            const { generateContractWithAi } = await import("@/modules/core/tools/contract-generator/contract-actions")
    ...
    const exportAsPdf = async () => {
        ...
        try {
            ...
            const { exportContractAsPdf } = await import("@/modules/core/tools/contract-generator/contract-actions")
