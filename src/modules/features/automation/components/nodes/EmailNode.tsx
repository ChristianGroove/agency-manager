            ...
            <div className="p-3 space-y-2">
                <div className="flex items-center gap-2 p-2 bg-fuchsia-50 dark:bg-fuchsia-950/20 rounded border border-fuchsia-100 dark:border-fuchsia-900/30">
                    ...
                    <div className="min-w-0 flex-1">
                        <p className="text-[10px] text-zinc-500 uppercase tracking-wide font-medium">Para</p>
                ...
                {subject && (
                    <p className="text-[10px] text-zinc-500 dark:text-zinc-400 italic truncate px-1">
                        "{subject}"
                    </p>
                )}
            </div>
