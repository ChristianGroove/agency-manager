            ...
            <DialogContent className="sm:max-w-xl">
                ...
                <div className="py-4">
                    <RadioGroup value={strategy} onValueChange={(v: any) => setStrategy(v)} className="gap-4">
                        ...
                        <div className={`flex items-start space-x-3 space-y-0 text-sm border p-4 rounded-xl cursor-pointer transition-all ${strategy === 'RETROACTIVE' ? 'border-amber-500 bg-amber-50 ring-1 ring-amber-500' : 'border-zinc-200 hover:bg-zinc-50'}`} onClick={() => setStrategy('RETROACTIVE')}>
                        ...
                        <div className={`flex items-start space-x-3 space-y-0 text-sm border p-4 rounded-xl cursor-pointer transition-all ${strategy === 'IGNORE_PAST' ? 'border-blue-500 bg-blue-50 ring-1 ring-blue-500' : 'border-zinc-200 hover:bg-zinc-50'}`} onClick={() => setStrategy('IGNORE_PAST')}>
                ...
                <DialogFooter>
                    ...
                    <Button onClick={handleConfirm} className="bg-black text-white hover:bg-zinc-800">
