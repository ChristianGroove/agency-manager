...
>(({ className, ...props }, ref) => (
    <DialogPrimitive.Overlay
        ref={ref}
        className={cn(
            "fixed inset-0 z-50 bg-black/65 backdrop-blur-md transition-all duration-300",
    ...
    <DialogPortal>
        ...
        <DialogPrimitive.Content
            ...
            className={cn(
                ...
                "gap-4 border border-gray-200 bg-background p-6 shadow-2xl rounded-xl scrollbar-thin",
                "data-[state=open]:animate-in data-[state=open]:fade-in-0 data-[state=open]:zoom-in-95 data-[state=open]:duration-300 data-[state=open]:ease-out",
        ...
        >
            <VisuallyHidden.Root>
                <DialogPrimitive.Title>Dialogo del Sistema</DialogPrimitive.Title>
                <DialogPrimitive.Description>
                    Este panel contiene información o acciones adicionales.
                </DialogPrimitive.Description>
            </VisuallyHidden.Root>
            {children}
