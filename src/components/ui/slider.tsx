...
>(({ className, trackClassName, rangeClassName, thumbClassName, ...props }, ref) => (
    <SliderPrimitive.Root
        ...
        {...props}
    >
        <SliderPrimitive.Track className={cn("relative h-2 w-full grow overflow-hidden rounded-full bg-zinc-200/90 dark:bg-zinc-800 border border-zinc-300/50 dark:border-white/10", trackClassName)}>
