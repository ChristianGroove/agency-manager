...
const TriggerNode = ({ data, selected }: { data: NodeData, selected: boolean }) => {
    ...
    return (
        <div className={cn(
            ...
            selected ? "border-green-500 shadow-xl scale-105 ring-1 ring-green-500" : "border-slate-200 dark:border-slate-800"
        )}>
            {/* Premium Header */}
            ...
            {/* Content */}
            <div className="p-3">
                <div className="text-xs text-slate-600 dark:text-slate-300 font-medium bg-slate-50 dark:bg-slate-950/50 p-2 rounded border border-slate-100 dark:border-slate-800/50 flex items-center gap-2">
