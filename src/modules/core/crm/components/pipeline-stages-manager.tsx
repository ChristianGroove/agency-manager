...
import { PipelineStage, getPipelineStages, createPipelineStage, updatePipelineStage, deletePipelineStage } from "../pipeline-actions"
...
export function PipelineStagesManager() {
    ...
    if (isLoading) {
        return <div className="p-8 text-center text-muted-foreground">Cargando etapas...</div>
    }
