    ...
    if (!isDev) {
        return (
            <div className="flex flex-col items-center justify-center h-[calc(100vh-10rem)] p-6 text-center space-y-4 max-w-md mx-auto">
                ...
                <h1 className="text-2xl font-bold tracking-tight">Gestión de Mesas Interactivas</h1>
                <p className="text-muted-foreground">
                    Este módulo se encuentra actualmente en <strong>Standby</strong> mientras finalizamos la integración de pedidos en vivo.
                </p>
                <div className="p-4 bg-muted rounded-lg text-sm text-left w-full">
                    <p className="font-semibold mb-2">Estado del Módulo:</p>
                    <ul className="space-y-1 list-disc list-inside text-muted-foreground">
                        <li>Arquitectura de Salones: <span className="text-green-600 font-medium">Completada</span></li>
                        <li>Diseño de Mesas (Builder): <span className="text-green-600 font-medium">Completado</span></li>
                        <li>Sincronización de Pedidos: <span className="text-amber-600 font-medium">En cola</span></li>
                    </ul>
                </div>
    ...
    return (
        <div className="flex flex-col flex-1 h-full w-full p-4 md:p-6 lg:p-8 space-y-4 max-w-7xl mx-auto">
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                <div>
                    <h1 className="text-3xl font-bold tracking-tight">Gestión de Salas y Mesas (Dev)</h1>
            ...
            <Alert className="bg-primary/5 text-primary border-primary/20">
                ...
                <AlertDescription>
                    Este módulo utiliza un motor de renderizado asíncrono basado en DOM absoluto. 
