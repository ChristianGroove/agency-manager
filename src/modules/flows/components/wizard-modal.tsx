...
export function WizardModal({ isOpen, onClose, templateId, onDeploy }: WizardModalProps) {
                ...
                return (
                    <div className="text-2xl leading-relaxed font-light text-gray-600 dark:text-gray-200">
                        ...
                        <input
                            ...
                            className="mx-2 w-16 bg-gray-100 dark:bg-gray-800 border-b-2 border-blue-500 text-center focus:outline-none rounded text-gray-900 dark:text-white"
                        />
                        ...
                        <input
                            ...
                            className="mx-1 w-20 bg-gray-100 dark:bg-gray-800 border-b-2 border-green-500 text-center focus:outline-none rounded text-gray-900 dark:text-white"
                        />
                        , enviar un <span className="text-purple-500 dark:text-purple-400 font-medium">Recordatorio Amable</span> por
                        <select
                            value={channel}
                            onChange={(e) => setChannel(e.target.value as any)}
                            className="mx-2 bg-gray-100 dark:bg-gray-800 border-b-2 border-purple-500 text-center focus:outline-none cursor-pointer rounded text-gray-900 dark:text-white"
                        >
            ...
            case 'budget_followup':
                return (
                    <div className="text-2xl leading-relaxed font-light text-gray-600 dark:text-gray-200">
                        ...
                        <input type="number" defaultValue={48} className="mx-2 w-16 bg-gray-100 dark:bg-gray-800 border-b-2 border-blue-500 text-center focus:outline-none rounded text-gray-900 dark:text-white" />
    ...
    return (
        <Dialog open={isOpen} onOpenChange={onClose}>
            <DialogContent className="max-w-2xl bg-white dark:bg-gray-950 border-gray-200 dark:border-gray-800 p-8">
