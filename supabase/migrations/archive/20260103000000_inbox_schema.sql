...
create table if not exists public.conversations (
    ...
    organization_id uuid not null default auth.uid(), -- Temporarily auth.uid, should be org
...
-- Policy: Authenticated users can view all conversations (for now)
...
begin
    ...
    set 
        last_message = jsonb_extract_path_text(new.content, 'text'), -- Simplified preview
