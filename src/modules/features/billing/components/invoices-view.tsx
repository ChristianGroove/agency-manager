...
export function InvoicesView({ initialInvoices }: InvoicesViewProps) {
    ...
    const handleBulkDelete = async () => {
        ...
        setIsDeleting(true)
        try {
            const { deleteInvoicesAction: deleteInvoices } = await import("../billing-actions")
    ...
    const handleSendEmail = async (invoice: Invoice) => {
        ...
        try {
            ...
            const { sendInvoiceEmailAction: sendEmail } = await import("@/modules/features/billing/billing-actions")
            const result = await sendEmail(invoice.id)
