...
import { getLeadAnalysis } from '@\/modules\/infrastructure\/ai/actions'
import { AnalysisRecommendation } from '@\/modules\/infrastructure\/ai/analysis-service'
import { getLeadWithRelations } from '../services/logic/crm-advanced-actions'
...
import { getActiveWorkflows, triggerWorkflowForLead } from '@/modules/features/automation/actions'
import { convertLeadToClientAction as convertLeadToClient, createContactTaskAction as createTask, completeContactTaskAction as completeTask, deleteContactTaskAction as deleteTask, getContactTasksAction as getTasksForLead } from '../crm-actions'
