...
import { duplicateQuote, updateQuote } from "@/modules/verticals/agency/quotes/actions"
import { convertQuote } from '@/modules/verticals/agency/quotes/conversion-actions'
...
export function QuotesView({ initialQuotes, initialEmitters }: QuotesViewProps) {
    ...
    const handleBulkDelete = async () => {
        ...
        setIsDeleting(true)
        try {
            const { deleteQuotes } = await import("@/modules/verticals/agency/quotes/actions")
