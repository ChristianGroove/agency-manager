...
import { createPortfolioItem, updatePortfolioItem } from "@/modules/verticals/agency/portfolio/actions"
import { getCategories, ServiceCategory } from "@/modules/verticals/agency/categories/actions"
import { toast } from "sonner"
import { cn } from "@/lib/utils"

interface PortfolioServiceSheetProps {
    open: boolean
...
export function PortfolioServiceSheet({
    ...
    const handleSubmit = async () => {
        ...
        try {
            if (itemToEdit) {
                await updatePortfolioItem(itemToEdit.id, formData)
                            ...
                            <Card className={cn(
                                ...
                                <CardContent className="space-y-4">
                                    ...
                                    <div className="flex items-center gap-2 p-3 bg-gray-50 rounded-lg text-sm">
                                        ...
                                        <span className="text-gray-700 font-medium">Incluye creación de briefing</span>
                                    </div>
                                </CardContent>
