...
import { EmailBlock, DEFAULT_BLOCKS, EmailBlockType } from '@/modules/infrastructure/notifications/services/types';
import { renderEmailFromBlocks } from '@/modules/infrastructure/notifications/services/email-renderer';
